...
const TabsContent = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & {
  ...
  <div
    ref={ref}
    className={cn(
      'mt-2 ring-offset-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ocean-500 focus-visible:ring-offset-2 dark:ring-offset-gray-950',
      className
    )}
    {...props}
  />
